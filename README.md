...
Corresponding *.onnx* models will be saved automatically during running `!python test_model.py` in `test_script.py` notebook (in *Face-Semantical-Segmentation* folder).
